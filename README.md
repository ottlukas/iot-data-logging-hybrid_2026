...
-   **[Lock] Secure Access**: JWT-based authentication for ingestion, synchronization, and dashboard access.
-   **[Bar Chart] Dual-Chart Dashboard**: Side-by-side Plotly visualizations showing "Local Buffer" vs. "IoTDB Cloud" datasets.
-   **[Circular Arrows] Real-time Updates**: 
    -   5-second auto-refresh with a visual countdown timer.
    -   Visual "pulse" indicators on status bars when data updates successfully.
-   **[Factory] Resilient Sync**: 
...
[Point Right] **[http://localhost:8000/dashboard](http://localhost:8000/dashboard)**
